...
public class PongLine extends Line2D.Double {
    ...
    /**
     * which side of the line (according to the direction Vector) is on the
     * inside of the playfield
     */
    private Side inside;
     ...
     *
     * set a new distance to the puck and move the last one to be the second
     * last one.
     *
     ...
     *
     * checks with the last to stored distances, if the puck is moving to the
     * line
     *
     * @return boolean
     */
